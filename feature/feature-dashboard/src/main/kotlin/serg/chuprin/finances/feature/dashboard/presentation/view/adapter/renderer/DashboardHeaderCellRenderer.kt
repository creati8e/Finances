...
import serg.chuprin.finances.feature.dashboard.presentation.model.cells.DashboardHeaderCell

/**
 * Created by Sergey Chuprin on 17.04.2020.
 */
class DashboardHeaderCellRenderer : ContainerRenderer<DashboardHeaderCell>() {
    override val type: Int = R.layout.cell_dashboard_header

    override fun bindView(holder: ContainerHolder, model: DashboardHeaderCell) {
        with(holder) {
